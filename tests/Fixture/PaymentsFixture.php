...
class PaymentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'form_payment_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'form_payment_id' => 1,
                'category_id' => 1,
                'created' => '2018-09-06 23:33:28',
                'modified' => '2018-09-06 23:33:28'
            ],
        ];
        parent::init();
    }
